...
import { updateProductMaterial } from "@/actions/productMaterial";
...
export default function EditProductMaterial({
  ...
  products,
  materials,
}: EditProductMaterialProps) {
  const [state, formAction, pending] = useActionState(
    updateProductMaterial.bind(null, productMaterial.id),
    initialState,
  );
    ...
    <Card>
      <CardBody>
        <Form action={formAction}>
          <Select
            isVirtualized
            defaultSelectedKeys={[productMaterial.productId]}
          ...
          <Select
            isVirtualized
            defaultSelectedKeys={[productMaterial.materialId]}
